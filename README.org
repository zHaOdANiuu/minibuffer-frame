...
** Known Limitations
- Requires a graphical Emacs session (child frames not available in terminal).
- Recursive minibuffer sessions are not explicitly handled (kept simple by design).
